...
namespace _1_Pacman
{
    internal class Program
    {
        ...
        private static char[,] ReadMap(string path)
        {
            ...
            char[,] map = new char[GetMaxLegthOfLines(file), file.Length];
        ...
        private static int GetMaxLegthOfLines(string[] lines)
        {
            int maxLegth = lines[0].Length;

            foreach(var line in lines)
                if (line.Length > maxLegth) 
                    maxLegth = line.Length;
